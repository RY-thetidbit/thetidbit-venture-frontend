...
const TermsAndConditions = () => {
  return (
    <>
      <Head>
        <title>Terms and Condition | TheTidbit</title>
        <meta name="description" content="Read our Terms and Condition for hassle-free returns and exchanges on sling bags, handbags, tote bags, and wallets at TheTidbit." />
      </Head>
